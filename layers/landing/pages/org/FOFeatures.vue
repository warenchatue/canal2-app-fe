<template>
  <div class="dark:bg-muted-900 bg-white py-12">
    <div class="mx-auto w-full max-w-7xl px-4">
      <div class="mb-10 max-w-2xl">
        ...
        >
          Vos contributions permettent de soutenir la plateforme, etc
        </BaseParagraph>
      </div>
      <div class="ptablet:grid-cols-2 grid gap-6 sm:grid-cols-3">
        <LandingLayersBox
          title="Réaliser des projets"
        ...
        <LandingLayersBox
          title="Venir en aide aux néccessiteux"
        ...
        <LandingLayersBox
          title="Promouvoir notre culture"
