  ...
  <div class="flex h-full flex-col">
    ...
    >
      <div class="flex-1">
        ...
        <BaseParagraph v-if="!props.centered" lead="none">
          <span class="text-primary-500 text-xs">{{ auth.user?.email }}</span>
        </BaseParagraph>
        <BaseParagraph lead="none" :class="props.centered && 'text-center'">
          <span class="text-muted-400 text-xs">Admin</span>
        </BaseParagraph>
      </div>
    ...
    <div class="mb-4 space-y-2 font-sans">
      ...
      >
        ...
        <span class="text-muted-400 text-xs">Douala, Cameroun</span>
      </div>
      <div
        class="flex items-end gap-2"
        :class="props.centered && 'justify-center'"
      >
        ...
        <span class="text-muted-400 text-xs">+237 694 68 27 13</span>
      </div>
    </div>
    <div
