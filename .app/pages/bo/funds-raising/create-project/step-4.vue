...
watch(project, (value) => {
  console.log('project.value.files')
  console.log(project.value.files)
})

// const dynamicPreview = useNinjaFilePreview(
//   (file) => file,
// )
// const fieldsWithErrors = computed(() => Object.keys(errors.value).length)

// const dynamicPreview = (file: File | null) => ()
</script>
...
<template>
  <div>
    ...
    <div class="px-4">
      <BasePlaceholderPage
        v-if="!toggled"
        title="Importer des fichiers au projet"
        subtitle="Ajoutez des fichiers à votre projet si vous les avez sous la main. Ne vous inquiétez pas, vous pourrez également gérer les fichiers ultérieurement."
      >
        <template #image>
          <img
        ...
        >
          ...
          >
            ...
            <ul v-else class="mt-6 space-y-2">
              <li v-for="file in project.files" :key="file.name">
                <div
