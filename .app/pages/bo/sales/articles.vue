...
function editArticle(article: any) {
  ...
  setFieldValue('article.email', article.email)
  setFieldValue('article.phone', article.phone)
  setFieldValue('article.country', article.country)
  setFieldValue('article.status', article.status)
}
        ...
        <div v-else class="mt-8" @click.>
          ...
          <div class="text-center">
            ...
            <BaseParagraph size="sm" class="text-muted-400">
              <span>{{ currentArticle?.email }}</span>
            </BaseParagraph>
            <div class="my-4">
              <BaseParagraph
                size="sm"
