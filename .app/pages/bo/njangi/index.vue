      ...
      <div class="grid grid-cols-12 gap-4">
        ...
        <div class="col-span-12 md:col-span-3">
          <BaseCard class="p-4">
            ...
            >
              <span class="text-sm">102 000 000</span>
              <span class="text-muted-400 text-sm">XAF</span>
            </div>
          </BaseCard>
        </div>
        <!-- Stat tile -->
        <div class="col-span-12 md:col-span-3">
          <BaseCard class="p-4">
            ...
            >
              <span class="text-sm">75 000 000</span>
              <span class="text-muted-400 text-sm">XAF</span>
            </div>
          </BaseCard>
        </div>
        ...
        <div class="col-span-12 md:col-span-3">
          <BaseCard class="p-4">
            ...
            <div
              class="text-danger-500 flex items-center gap-1 font-sans text-sm"
            >
              <span class="text-sm">50 000 000</span>
              <span class="text-muted-400 text-sm">XAF</span>
            </div>
          </BaseCard>
        </div>
          ...
          <BaseCard class="p-4">
            <div class="mb-1 flex items-center justify-between">
              <BaseHeading
                ...
                class="text-muted-500 dark:text-muted-400"
              >
                <span>Emprunts Particuliers</span>
              </BaseHeading>
              <BaseIconBox
                size="xs"
                class="bg-primary-100 text-primary-500 dark:bg-primary-500/20 dark:text-primary-400 dark:border-primary-500 dark:border-2"
            ...
            <div
              class="text-danger-500 flex items-center gap-1 font-sans text-sm"
            >
              <span class="text-sm">150 000 000</span>
              <span class="text-muted-400 text-sm">XAF</span>
            </div>
          </BaseCard>
        </div>
          ...
          <BaseCard class="flex h-full flex-col p-6">
            <div class="mb-5 flex items-center justify-between">
              <BaseHeading
                ...
                class="text-muted-800 dark:text-white"
              >
                <span>Evolution des remboursements</span>
              </BaseHeading>
            </div>
            <div class="mb-6">
