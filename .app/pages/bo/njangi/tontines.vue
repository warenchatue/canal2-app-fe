...
const activeEntity = ref({ id: '', name: '', category: '', image: '' })
...
<template>
  <div class="!max-w-8xl">
    <TairoContentWrapper class="!max-w-8xl">
      <template #left>
        <BaseInput
          v-model="filter"
          icon="lucide:search"
          placeholder="Filtrer tontine..."
          :classes="{
        ...
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            <div class="mb-2">
              ...
              >
                <span>{{ data.meta.totalSpendNjangi }} XAF</span>
              </BaseHeading>
            </div>
            <div
            ...
            >
              <span>50</span>
              <span class="text-muted-400 text-sm">tontines</span>
            </div>
          </BaseCard>
        </div>
        <!-- Stat tile -->
          ...
          <BaseCard class="p-4">
            ...
            <div class="mb-2">
              <BaseHeading
                ...
                class="text-muted-800 dark:text-white"
              >
                <span>200 000 000 XAF</span>
              </BaseHeading>
            </div>
            <div
              class="text-danger-500 flex items-center gap-1 font-sans text-sm"
            >
              <span>{{ data.meta.totalAcquiredNjangi }}</span>
              <span class="text-muted-400 text-sm">tontines</span>
            </div>
          </BaseCard>
        </div>
          ...
          <BaseCard class="p-4">
            ...
            <div class="mb-2">
              <BaseHeading
                ...
                class="text-muted-800 dark:text-white"
              >
                <span>{{ data.meta.totalNAAmount }} XAF</span>
              </BaseHeading>
            </div>
            <div
              class="text-success-500 flex items-center gap-1 font-sans text-sm"
