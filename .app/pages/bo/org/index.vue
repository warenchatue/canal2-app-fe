...
definePageMeta({
  title: 'Profil de Organisatin',
  preview: {
    title: 'Profil de Organisatin',
    description: 'For displaying a org profile',
    categories: ['bo', 'org'],
...
const orgLink = 'http://localhost:3000/org/' + app.activeOrg.slug
const donationLink =
  'http://localhost:3000/org/contribution/' + app.activeOrg.slug
...
const handleClipboard = (textLink: string) => {
  copy(textLink)
  if (copied) {
    console.log('Lien copié, vous pouvez le partager a vos donateurs')
    toaster.clearAll()
    toaster.show({
      title: 'Success',
      message: `Lien copié, vous pouvez le partager a vos donateurs !`,
      color: 'success',
      icon: 'ph:check',
      closable: true,
    })
  ...
  <div class="mx-auto w-full max-w-6xl">
    ...
    <div v-else class="relative w-full">
      <div class="absolute end-0 top-2 z-20">
        ...
        >
          <BaseDropdownDivide />
          <BaseDropdownItem to="/org/org-edit" title="Edit" text="Edit profile">
            <template #start>
      ...
      <div class="flex w-full flex-col">
        <BaseAvatar
          :src="data?.org.medias.logo"
          :badge-src="data?.org.medias.badge"
          size="2xl"
          class="mx-auto"
        />
          ...
          >
            ...
            >
              ...
              <BaseText
                ...
                @click="handleClipboard(orgLink)"
                >lien de l'organisation</BaseText
              >
            </div>
            <div
              class="text-muted-400 hidden h-8 items-center gap-1 px-4 sm:flex"
            >
              ...
              <BaseText
                size="sm"
                class="hover:cursor-pointer"
                @click="handleClipboard(donationLink)"
                >faire un don</BaseText
              >
            </div>

            <div class="flex h-8 items-center gap-2 px-4">
              <NuxtLink
                v-for="link in data?.org.socials"
                :key="link.name"
                :to="link.url"
                target="_blank"
          ...
          <div class="flex flex-col gap-6">
            <BaseCard class="p-8">
              ...
              <div class="border-muted-200 dark:border-muted-700 border-b py-8">
                ...
                <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2">
                  <div
                    v-for="item in data.org.experiences"
                    :key="item.company"
              ...
              <div class="border-muted-200 dark:border-muted-700 border-b py-8">
                ...
                <div class="grid gap-x-4 gap-y-8 sm:grid-cols-2">
                  <div
                    v-for="item in data.org.languages"
                    :key="item.name"
                    class="flex w-full items-center gap-2"
                  >
                    <div
            ...
            <BaseCard class="p-8">
              ...
              <div class="grid gap-6 sm:grid-cols-2">
                <div
                  v-for="item in data.org.recommandations"
                  :key="item.name"
