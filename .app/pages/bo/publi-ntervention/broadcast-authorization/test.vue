...
function editBroadcastAuth(auth: any) {
  ...
  form.setFieldValue('broadcastAuthorization.serviceInCharge', auth.serviceInCharge)
  ...
  form.setFieldValue('broadcastAuthorization.contactDetails', auth.contactDetails)
  form.setFieldValue(
  ...
  form.setFieldValue('broadcastAuthorization.otherKeyContact', auth.otherKeyContact)
  form.setFieldValue(
