...
const { data, pending, error, refresh } = await useFetch('/api/donations', {
  query,
})
            ...
            <TairoTable shape="rounded">
              ...
              <TairoTableRow v-for="item in data?.data" :key="item.id">
                ...
                <TairoTableCell spaced>
                  <div class="flex items-center">
                    <BaseAvatar
                      :src="item.customer.medias.avatar"
                      :text="item.initials"
